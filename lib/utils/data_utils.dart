import 'package:osc_demo/models/User.dart';
...
class DataUtils {
  ...
  static Future<String> getAccessToken() async {
    SharedPreferences sp = await SharedPreferences.getInstance();
    String assessToken = await sp.getString(SP_ACCESS_TOKEN);
    return assessToken;
  }
  ...
  static Future<User> getUserInfo() async{
    ...
    user.name = sp.get(SP_USER_NAME);
    user.location = sp.get(SP_USER_LOCATION);
